...
// ----------------------------------------------------
export function handleGenerateInvoiceNo(generateSOUrl) {
    $("#addInvoiceModal").on("show.bs.modal", function () {
        $.get(generateSOUrl, function (data) {
            $("#addInvoiceNumber").val(data.invoice_number);
            $("#addInvoiceNumberHidden").val(data.invoice_number);
        });
    });
}
...
$(document).ready(function () {
    ...
    handleGenerateInvoiceNo($("#addInvoiceNumber").data("url"));
