                    ...
                    <form method="POST" action="{{ route('labels.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                <label>Client <span class="text-muted">(Optional)</span></label>
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="categorySelect" class="required-field">Product Category</label>
                            ...
                            <div class="mb-3 col-md-2">
                                ...
                                <input id="totalQuantity" value="0" type="number" class="form-control input-disabled-look">
                            </div>
                        ...
                        <div class="mb-3">
                                    ...
                                    <div class="card-body p-2">
                                        <div class="row g-2 align-items-end">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control client-part-no input-disabled-look"
                                                    readonly>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" name="prefixes[]" class="form-control" placeholder="TE-202512">
                                            </div>
                            ...
                            <button type="button" class="btn btn-sm btn-secondary mt-2" onclick="addLabelRow()">
                                + Add New Label
                            </button>
                        </div>
...
@push('scripts')
    <script>
        ...
        fn($p) =>
        "<option value='{$p->id}' data-part-no='{$p->our_part_no}' data-category='{$p->category}'>
                {$p->our_part_no}
            </option>"
    )->implode('') !!}`;
    </script>
