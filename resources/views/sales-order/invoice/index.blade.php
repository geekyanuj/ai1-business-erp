        ...
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="add-salesorder-container">
                    ...
                    <button class="btn bg-my-primary btn-sm text-white" data-bs-toggle="modal"
                        ...
                        <i class="fa-solid fa-plus"></i> New Invoice</button>
            ...
            <div class="card shadow-sm">
                <div class="card-body p-2">
                    <table id="orderTable" data-url="{{ route('sales-orders.invoices.data') }}"
            ...
            <div class="modal-content">
                <form id="addInvoiceForm" action="{{ route('invoices.store') }}" method="POST"
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title my-primary-color" id="addInvoiceModalLabel">Create New Invoice</h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="addInvoiceDate" value="{{ date('d-m-Y') }}"
                                    disabled>
                                <!-- Hidden field for submission -->
                                <input type="hidden" name="invoice_date" id="addInvoiceDateHidden"
                                    value="{{ date('Y-m-d') }}">
                            </div>

                            <div class="col-md-3">
                                <label for="addInvoiceNumber" class="form-label">Invoice No. </label>
                                <input type="text" class="form-control" id="addInvoiceNumber" value="" data-url={{ route('sales-orders.invoices.generate-invoice-number') }} disabled>
                                <input type="hidden" id="addInvoiceNumberHidden" name="invoice_number">
                            </div>

                            <div class="col-md-3">
                                <label for="addInvoiceStatus" class="form-label required-field">Current Status</label>
                                <select name="status" id="addInvoiceStatus" class="form-select" required>
                            ...
                            <div class="col-md-3">
                                <label for="addPaymentMode" class="form-label required-field">Payment Mode</label>
                                <select name="payment_mode" id="addPaymentMode" class="form-select" required>
                                    <option value=""></option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="client_po_ref" class="form-control" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label">Client's PO (Optional)</label>
                                <input type="file" name="client_po_pdf" class="form-control" accept="application/pdf">
                            </div>
...
@push('scripts')
    ...
    @vite('resources/js/pages/sales-order/invoice/index.js')
@endpush