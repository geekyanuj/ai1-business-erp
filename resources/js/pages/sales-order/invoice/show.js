...
export function initUpdateInvoiceModal() {
    handleSalesItems({
        enableDiscount: false,
...
$(document).on("click", ".update-invoice-btn", function () {
    ...
    $("#update_invoice_id").val(invoice.id);
    $("#updateInvoiceDate").val(invoice.invoice_date);
    $("#updateInvoiceNumber").val(invoice.invoice_number);
    $("#updateInvoiceNumberHidden").val(invoice.invoice_number);
    $("#updatePaymentMode").val(invoice.payment_mode);
    $("#updateClient").val(invoice.client_id);
    ...
    $.get(`/clients/${invoice.client_id}/addresses`, function (addresses) {
        resetChoices(billingSel.choices, addresses, invoice.billing_address_id);
        resetChoices(shippingSel.choices, addresses, invoice.shipping_address_id);
    });
